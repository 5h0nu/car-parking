<?php
// Prevent direct access to sidebar file
...
$nav_items = [
    ...
    [
        'label' => 'Exit Vehicle',
        'url' => 'exit_vehicle.php',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>'
    ],
    [
        'label' => 'View Slots',
        'url' => 'view_slots.php',
    ...
    [
        'label' => 'Billing',
        'url' => 'billing.php',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5h16.5c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125H3.75m0-12c-.621 0-1.125.504-1.125 1.125v9.75c0 .621.504 1.125 1.125 1.125m0-12v12m0 0h16.5" /></svg>'
    ],
    [
        'label' => 'Reports',
        'url' => 'reports.php',
...
<div class="sidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="profile-info">
            ...
            <span class="profile-role"><?php echo htmlspecialchars(ucfirst($role)); ?>istrator</span>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        <?php foreach ($nav_items as $item): ?>
            ...
            ?>
            <a href="<?php echo htmlspecialchars($item['url']); ?>" class="nav-item <?php echo $is_active; ?>">
